...
def show_images():
    ...
    try:
        if(len(list_of_jpg_files)>0): # if there are images present, show them on a wen UI
            ...
            return "Please try out different string that is to be searched" # show this error message if no images are present in the static folder
    except Exception as e:
        print('no Images found ', e)
        return "Please try out different string that is to be searched"
